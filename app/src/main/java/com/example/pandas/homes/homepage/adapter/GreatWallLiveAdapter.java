 ...
 */
public class GreatWallLiveAdapter extends RecyclerView.Adapter {

    private Context context;
    private ArrayList<HomePageBean.DataBean.WallliveBean.ListBeanX> list;

    public GreatWallLiveAdapter(ArrayList<HomePageBean.DataBean.WallliveBean.ListBeanX> list, Context context) {
        this.list = list;
