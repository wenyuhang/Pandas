...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public void init(Context context) {
        ...
        definition = (Button) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.definition);
        share = (ImageView) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.share);
        collect = (CheckBox) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.collect);
    ...
    public static void setTrigger(Trigger trigger) {
        JCVideoPlayerStandard.trigger = trigger;
    }
    ...
    public static void setOnCollect(OnCollect onCollect) {
        JCVideoPlayerStandard.onCollect = onCollect;
    }
