...
public class OkHttpUtils implements com.example.apps.networks.IHttp {
    private static com.example.apps.networks.OkHttpUtils utils;
    ...
    public static com.example.apps.networks.OkHttpUtils getInstance(){
        if(utils==null){
            synchronized (com.example.apps.networks.OkHttpUtils.class){
                if(utils==null) {
                    utils=new com.example.apps.networks.OkHttpUtils();
                }
            }
        }
        return utils;
    ...
    public <T> void get(String url, Map<String, String> params, final NetCallbacks callback) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, final IOException e) {
                com.example.apps.app.App.context.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
